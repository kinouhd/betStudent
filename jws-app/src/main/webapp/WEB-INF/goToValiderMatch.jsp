...
<div class="w3-container w3-display-middle w3-grey w3-round-xxlarge w3-lobster">
    <h1 class="w3-container w3-center w3-lobster">Liste des paris à cloturer</h1>
            ...
            <s:iterator value="listeMatch">
                <tr>
                    <td style="text-align: center;">
                        <s:url action="selectionValiderMatch" var="monUrl">
                    ...
                    <td style="text-align: center"><s:a href="%{#monUrl}" cssClass=" w3-round-xxlarge w3-lobster">Valider le match</s:a></td>
                </tr>
            </s:iterator>
        </table>
    </div>
