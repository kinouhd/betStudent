...
<div class="w3-container w3-display-middle w3-grey w3-round-xxlarge w3-lobster" >
    <h1 class="w3-container w3-center w3-lobster">Mes paris</h1>
    ...
    <div>
        <table class="w3-table w3-textMatch">
            <s:iterator value="listeMatch">
                <tr>
                    <td style="text-align: center;"><s:property value="equipeDOM"/></td>
                    <td style="text-align: center">     </td>
                    <td style="text-align: center;"><s:property value="scoreDOM"/></td>
                    <td style="text-align: center;"> - </td>
                    <td style="text-align: center;"><s:property value="scoreEXT"/></td>
                    <td style="text-align: center">     </td>
