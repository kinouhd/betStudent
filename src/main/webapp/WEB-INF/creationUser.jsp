...
<div class="w3-container w3-display-middle w3-grey w3-round-xxlarge w3-lobster">
    <h1 class="w3-container w3-center w3-lobster">Formulaire creation d'utilisateur</h1>


    <div class="w3-textMatch">
        <s:form action="creationUser">
            <s:textfield name="pseudo" label="Pseudo"/>
            <s:password name="pswd" label="Mot de passe"/>
            <s:submit value="Créer utilisateur" cssClass=" w3-lobster"/>
        </s:form>
    </div>
